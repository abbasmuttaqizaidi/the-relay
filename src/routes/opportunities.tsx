...
import { Loader2, BadgeCheck, Check, Search, MapPin, Briefcase, Calendar, Users, Building, ExternalLink, RefreshCw, SlidersHorizontal, Trash2 } from "lucide-react";
...
function OpportunitiesPage() {
  ...
  }, [activeIndustries, activeGeos, type, q, minInterested, maxInterested]);
      ...
      <div className="flex-1 space-y-3.5">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-[9px] text-slate-400 font-medium">#{opp.id}</span>
          </div>
